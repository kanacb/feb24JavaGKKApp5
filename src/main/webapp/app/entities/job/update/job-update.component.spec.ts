...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 30614 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 27271 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 19155 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 19725 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 31458 };
      job.tasks = [task];
      const employee: IEmployee = { id: 4703 };
      job.employee = employee;
