...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 30178 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 10532 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 17607 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 23714 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 25461 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 2403 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 31139 };
      jobHistory.job = job;
      const department: IDepartment = { id: 23774 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 24320 };
      jobHistory.employee = employee;
