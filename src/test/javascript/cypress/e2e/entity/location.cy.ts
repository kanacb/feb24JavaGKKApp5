...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('geez');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'geez');

      cy.get(`[data-cy="postalCode"]`).type('save reluctantly');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'save reluctantly');

      cy.get(`[data-cy="city"]`).type('Kearaburgh');
      cy.get(`[data-cy="city"]`).should('have.value', 'Kearaburgh');

      cy.get(`[data-cy="stateProvince"]`).type('accidentally niece ugh');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'accidentally niece ugh');
