...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('very battalion weakness');
      cy.get(`[data-cy="title"]`).should('have.value', 'very battalion weakness');

      cy.get(`[data-cy="description"]`).type('besides impure');
      cy.get(`[data-cy="description"]`).should('have.value', 'besides impure');
