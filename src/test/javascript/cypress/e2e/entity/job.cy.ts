...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Product Marketing Associate');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Product Marketing Associate');

      cy.get(`[data-cy="minSalary"]`).type('22022');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '22022');

      cy.get(`[data-cy="maxSalary"]`).type('12642');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '12642');
