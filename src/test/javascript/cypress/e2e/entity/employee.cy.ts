...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Alvera');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Alvera');

      cy.get(`[data-cy="lastName"]`).type('Hermiston');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Hermiston');

      cy.get(`[data-cy="email"]`).type('Deangelo53@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Deangelo53@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('incidentally');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'incidentally');

      cy.get(`[data-cy="hireDate"]`).type('2024-03-01T01:51');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-03-01T01:51');

      cy.get(`[data-cy="salary"]`).type('28396');
      cy.get(`[data-cy="salary"]`).should('have.value', '28396');

      cy.get(`[data-cy="commissionPct"]`).type('17801');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '17801');
