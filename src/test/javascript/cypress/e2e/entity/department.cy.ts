...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'bamboo doc' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('latency um except');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'latency um except');
