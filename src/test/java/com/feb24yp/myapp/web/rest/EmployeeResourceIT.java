...
import com.feb24yp.myapp.domain.Employee;
import com.feb24yp.myapp.repository.EmployeeRepository;
...
class EmployeeResourceIT {
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.firstName(UPDATED_FIRST_NAME).phoneNumber(UPDATED_PHONE_NUMBER).salary(UPDATED_SALARY);
